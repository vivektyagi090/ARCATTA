      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {activeData.items.map((item, idx) => {
          ...
          return (
            <Link
              key={idx}
              href={`/products/${activeData.id}/${productSlug}`}
              className="group bg-white rounded-2xl p-6 border border-stone-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer block"
            >
              ...
              <div className="flex items-start justify-between mb-2">
                <h4 className="text-lg font-bold text-stone-900 group-hover:text-green-700 transition-colors">
                  {item.name}
                </h4>
                {item.applications && (
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <ChevronRight
                  size={16}
                  className="text-stone-400 group-hover:text-green-600 transform group-hover:translate-x-1 transition-transform"
                />
              </div>
            </Link>
          );
